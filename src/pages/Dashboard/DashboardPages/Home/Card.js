  ...
  return (
    <>
      <Link to={to} className="w-full xl:w-1/3 lg:w-full min-w-max lg:w-1/2">
        <div
          className={`px-3 border-dashed bg-${border_color}-100 border-2 mx-10 my-7 border-${border_color}-400 py-5 px-2 rounded-lg hover:shadow-xl transform hover:scale-105 flex flex-row justify-center items-center cursor-pointer`}
        >
          <p
