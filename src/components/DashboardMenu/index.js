...
export const DashboardMenu = () => (
  <>
    ...
    <span className="flex flex-row w-full">
      <Link
        className="flex flex-row justify-center w-full px-5 py-2 mb-4 text-center text-gray-500 border btn-animations rounded-md hover:bg-blue-200 transform hover:scale-105 hover:border-blue-200"
        to="/dashboard"
      >
